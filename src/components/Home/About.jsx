...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Absolutely amazing! from when i phoned to organize to when the car had been dropped off, the service, price and people were amazing! i shopped around for quotes some come out at £350! but Cambridge car solutions were by far the cheapest, Lee was brilliant, very professional, i would recommend 110%, i will definitely be using again in the future, THANK YOU!!!!!!!",
    name: "Jon Clarke",
  },
