...
const services = [
  {
    title: "Buy Old Vehicles",
    desc: `We buy and recycle old and scrap vehicles, contact us for a free quote.`,
    image: "/carpaint.avif",
    path: "/services/mechanical",
  },
  {
    title: "24 HR Vehicle Recovery",
    desc: `Have you broken down? We offer a comprehensive and professional recovery service.
​`,
    image: "/gray.avif",
  ...
  },
  {
    ...
    desc: `Have you broken down and need help towing your car? Call us today and we’ll come to rescue.`,
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[95%] mt-15 h-35 mx-auto object-cover"
                    onError={(e) => {
